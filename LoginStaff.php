            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login Staff</h5>
                  ...
                  <?php include('errors.php'); ?>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="login_staff">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Bukan staf? <a href="lamanutama.php">Pergi ke bahagian ibubapa</a></p>
                    </div>
                  </form>
